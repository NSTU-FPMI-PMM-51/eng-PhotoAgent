			...
			items: [
				{
					...
					ru: 'Первое: барьер экспертизы. Эффективное взаимодействие требует экспертных знаний. Непрофессиональные пользователи часто испытывают трудности либо с разработкой чётких и точных инструкций по редактированию (например, разложить запрос «улучшить моё фото» на детальные шаги), либо с оценкой того, соответствуют ли результаты редактирования профессиональным стандартам качества.',
				},
				{
					...
					ru: 'Второе: выбор алгоритма. Разные задачи редактирования требуют разных специализированных моделей. Единой модели может быть недостаточно для всех задач, поэтому пользователям необходимо переключаться между моделями для достижения желаемых результатов.',
				},
				{
			...
			sentences: [
				{
					...
					ru: 'Ранние новаторские работы в основном использовали генеративно-состязательные сети (GAN) или условные архитектуры кодировщик-декодер для таких задач, как перенос стиля и манипуляция атрибутами.',
				},
				{
			...
			sentences: [
				{
					...
					ru: 'Чтобы преодолеть вышеуказанные ограничения, многообещающим направлением является разработка структуры автономного агента, способного к многошаговому планированию и выполнению.',
				},
				{
			...
			sentences: [
				{
					...
					ru: 'В автоматизированном конвейере редактирования изображений оценщик очень важен, поскольку он задаёт функцию вознаграждения, которая направляет действия агента и определяет конечный результат.',
				},
				{
